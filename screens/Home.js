...
const Home = ({ navigation}) => {
    ...
    const bookAshei = {
        ...
        readed: "12k",
        description: "a young woman try to discover who is her, what is her History.",
    ...
    const bookAsheii = {
        ...
        readed: "13k",
        description: "She wasn't alone, she did not the only one ",
                ...
                <View style={{ flexDirection: 'row', height: 70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    ...
                    >
                        <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.black }}>Claim</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.black }}>Get Point</Text>
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.base, ...FONTS.body3, color: COLORS.black }}>Card</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
